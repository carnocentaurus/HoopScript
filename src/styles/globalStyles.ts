...
export const globalStyles = StyleSheet.create({
  ...
  qsLogoPlaceholder: { fontSize: 40, color: COLORS.white, fontWeight: '900', backgroundColor: '#222', width: 80, height: 80, textAlign: 'center', lineHeight: 80, borderRadius: 40, marginBottom: 10 },
  qsCityName: { color: '#888', fontSize: 12, fontWeight: 'bold', textTransform: 'uppercase' },
  qsScore: { color: COLORS.text, fontSize: 54, fontWeight: '900', marginTop: 10 },
  qsVs: { color: '#333', fontWeight: '900', fontSize: 18 },
  ...
  stBackButton: { fontWeight: 'bold', color: COLORS.black },
  stTitle: { fontSize: 18, fontWeight: '900', letterSpacing: 1 },
  stTabBar: { flexDirection: 'row', borderBottomWidth: 1, borderColor: '#EEE' },
  stTab: { flex: 1, padding: 15, alignItems: 'center' },
  stActiveTab: { borderBottomWidth: 3, borderColor: COLORS.black },
  stTabText: { color: '#AAA', fontWeight: 'bold' },
  stActiveTabText: { color: COLORS.black },
  stTableHeader: { flexDirection: 'row', padding: 15, backgroundColor: '#F9F9F9', borderBottomWidth: 1, borderColor: '#EEE' },
  stHeaderRank: { width: 30, fontSize: 10, color: '#999', fontWeight: 'bold' },
  stHeaderTeam: { flex: 1, fontSize: 10, color: '#999', fontWeight: 'bold' },
  stRecordColsHeader: { flexDirection: 'row', width: 60, justifyContent: 'space-between' },
  stHeaderStat: { fontSize: 10, color: '#999', fontWeight: 'bold', width: 25, textAlign: 'center' },
  stTeamRow: { flexDirection: 'row', padding: 15, alignItems: 'center', borderBottomWidth: 1, borderColor: '#F0F0F0' },
  stUserRow: { backgroundColor: '#FFFBEB' },
  stRankText: { width: 30, fontWeight: 'bold', color: '#666' },
  stCityName: { flex: 1, fontWeight: '600', fontSize: 16 },
  stRecordCols: { flexDirection: 'row', width: 60, justifyContent: 'space-between' },
  stRecordText: { width: 25, textAlign: 'center', fontWeight: 'bold' },
  ...
  drTeamViewBtn: { backgroundColor: COLORS.secondary, paddingHorizontal: 12, paddingVertical: 6, borderRadius: 15, borderWidth: 1, borderColor: '#4A5568' },
  ...
  drPlayerCard: { flexDirection: 'row', backgroundColor: COLORS.white, padding: 15, borderRadius: 12, marginBottom: 10, alignItems: 'center', elevation: 2 },
  drPlayerInfo: { flex: 1 },
  drPlayerName: { fontSize: 18, fontWeight: '900', color: COLORS.darkBg },
  ...
  drSummaryRow: { flexDirection: 'row', alignItems: 'center', backgroundColor: COLORS.white, padding: 12, borderRadius: 10, marginBottom: 8, borderWidth: 1, borderColor: '#EDF2F7' },
  ...
  drSummaryPlayer: { fontSize: 14, fontWeight: '800', color: COLORS.darkBg },
  drSummaryRating: { alignItems: 'center' },
  drSummaryRatingVal: { fontSize: 14, fontWeight: '900', color: COLORS.secondary },
  ...
  tosTitle: { color: COLORS.black, fontSize: 18, fontWeight: '900', letterSpacing: 1 },
  ...
  tosTeamRatingVal: { fontSize: 22, fontWeight: '900', color: COLORS.secondary },
  tosTeamOvrVal: { color: COLORS.primary },
  tosTeamRatingLabel: { fontSize: 9, color: COLORS.textMuted, fontWeight: '800', marginTop: 2 },
  tosSectionHeader: { color: COLORS.secondary, fontSize: 12, fontWeight: '900', letterSpacing: 2, marginBottom: 10, marginLeft: 5 },
  tosPlayerCard: { backgroundColor: COLORS.white, borderRadius: 12, padding: 15, marginBottom: 12, borderWidth: 1, borderColor: '#EDF2F7', elevation: 2 },
  tosPlayerHeader: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', marginBottom: 10 },
  tosPlayerMain: { fontSize: 18, fontWeight: '900', color: COLORS.darkBg },
  ...
  tosRatingVal: { fontSize: 16, fontWeight: 'bold', color: COLORS.secondary },
  ...
  toHeaderText: { fontSize: 20, fontWeight: 'bold', flex: 1, textAlign: 'center' },
  toTeamStatsRow: { flexDirection: 'row', justifyContent: 'center', gap: 30, marginBottom: 20 },
  toStatBox: { alignItems: 'center' },
  toStatVal: { fontSize: 24, fontWeight: 'bold' },
  toStatLabel: { fontSize: 10, color: '#666' },
  toPlayerCard: { flexDirection: 'row', padding: 15, borderBottomWidth: 1, borderBottomColor: '#EEE', alignItems: 'center' },
  toPlayerPos: { width: 40, fontWeight: 'bold', color: '#666' },
  toPlayerName: { flex: 1, fontSize: 16 },
  toPlayerOvr: { fontWeight: 'bold', fontSize: 16 },
  toSectionHeader: { backgroundColor: '#F5F5F5', padding: 10, paddingHorizontal: 15 },
  toSectionHeaderText: { fontSize: 12, fontWeight: 'bold', color: '#333', letterSpacing: 1 },
  ...
  // --- HISTORY SCREEN ---
  hiHeader: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', padding: 20, borderBottomWidth: 1, borderBottomColor: '#222' },
  ...
  hiHistoryCard: { backgroundColor: '#111', borderRadius: 16, marginBottom: 15, padding: 20, borderWidth: 1, borderColor: '#222' },
  ...
  hiUserSummary: { flexDirection: 'row', gap: 10, marginTop: 12, borderTopWidth: 1, borderTopColor: '#222', paddingTop: 12, alignItems: 'center' },
  hiUserLabel: { color: '#444', fontSize: 10, fontWeight: '900', letterSpacing: 1 },
  hiUserStat: { color: '#888', fontSize: 13, fontWeight: 'bold' },
  hiEmptyContainer: { padding: 40, alignItems: 'center' },
  hiEmptyText: { color: '#444', fontSize: 16, fontWeight: 'bold', textAlign: 'center' },
  ...
  pbTitle: { fontSize: 18, fontWeight: '900', color: COLORS.secondary },
  ...
  pbSeriesCard: { backgroundColor: COLORS.white, borderRadius: 12, padding: 15, marginBottom: 12, elevation: 2 },
  ...
  pbTeamName: { fontSize: 16, fontWeight: '700', color: '#4A5568' },
  pbWinner: { color: COLORS.primary },
  pbScore: { fontSize: 16, fontWeight: '900', color: COLORS.secondary },
  pbSimDayBtn: { backgroundColor: COLORS.secondary, margin: 20, padding: 18, borderRadius: 12, alignItems: 'center' },
  pbNextSeasonBtn: { backgroundColor: '#48BB78' },
  pbSimDayBtnText: { color: COLORS.white, fontWeight: 'bold' },
  pbChampContainer: { alignItems: 'center', marginTop: 20, padding: 20 },
  pbChampText: { fontSize: 20, fontWeight: '900', color: COLORS.secondary },

  // --- TEAM SELECTION SCREEN ---
  tsHeader: { fontSize: 20, fontWeight: '700', textAlign: 'center', marginVertical: 20, flex: 1 },
  ...
  tcLogoCircle: { width: 50, height: 50, borderRadius: 25, backgroundColor: '#F0F0F0', justifyContent: 'center', alignItems: 'center', marginBottom: 5 },
  tcLogoLetter: { fontSize: 24, fontWeight: '600' },
  tcCityText: { fontSize: 12, textAlign: 'center' },
});
