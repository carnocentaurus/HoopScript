...
export const globalStyles = StyleSheet.create({
  ...
  dlRevealContainer: { height: 350, justifyContent: 'center', alignItems: 'center', padding: 20 },
  ...
  dlCityCard: { backgroundColor: COLORS.card, width: '100%', padding: 40, borderRadius: 20, alignItems: 'center', borderWidth: 2, borderColor: COLORS.border, marginBottom: 30 },
  ...
  dlJumpBadge: { backgroundColor: COLORS.success, paddingHorizontal: 10, paddingVertical: 4, borderRadius: 4, marginTop: 15 },
  dlJumpText: { color: COLORS.white, fontSize: 10, fontWeight: '900' },
  dlSummaryList: { flex: 1, flexDirection: 'row', flexWrap: 'wrap', padding: 10, justifyContent: 'center' },
  dlSummaryItem: { width: '45%', flexDirection: 'row', backgroundColor: COLORS.card, margin: 5, padding: 10, borderRadius: 8, opacity: 0.3 },
  dlRevealedItem: { opacity: 1, borderColor: COLORS.primary, borderWidth: 1 },
  dlSummaryPick: { color: COLORS.primary, fontWeight: '900', width: 30 },
  dlSummaryCity: { color: COLORS.white, fontWeight: '700' },
  dlProjectedList: { flex: 1, paddingHorizontal: 20 },
  dlProjectedRow: { flexDirection: 'row', justifyContent: 'space-between', paddingVertical: 12, borderBottomWidth: 1, borderBottomColor: COLORS.border },
