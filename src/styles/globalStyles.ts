...
export const globalStyles = StyleSheet.create({
  ...
  stHeaderTeam: { flex: 1, minWidth: 120, fontSize: 10, color: COLORS.textMuted, fontFamily: FONTS.primary, textTransform: 'uppercase' },
  stRecordColsHeader: { flexDirection: 'row', width: 260, justifyContent: 'space-between' },
  stHeaderStat: { fontSize: 10, color: COLORS.textMuted, fontFamily: FONTS.primary, width: 35, textAlign: 'center', textTransform: 'uppercase' },
  stHeaderStatWp: { fontSize: 10, color: COLORS.textMuted, fontFamily: FONTS.primary, width: 70, textAlign: 'center', textTransform: 'uppercase' },
  stHeaderStatL10: { fontSize: 10, color: COLORS.textMuted, fontFamily: FONTS.primary, width: 60, textAlign: 'center', textTransform: 'uppercase' },
  ...
  stCityName: { flex: 1, minWidth: 120, fontFamily: FONTS.secondary, fontSize: 18, color: COLORS.text },
  stRecordCols: { flexDirection: 'row', width: 260, justifyContent: 'space-between', alignItems: 'center' },
  stRecordText: { width: 35, textAlign: 'center', fontFamily: FONTS.primary, color: COLORS.text },
  stRecordTextWp: { width: 70, textAlign: 'center', fontFamily: FONTS.primary, color: COLORS.text },
  stRecordTextL10: { width: 60, textAlign: 'center', fontFamily: FONTS.primary, color: COLORS.text },
