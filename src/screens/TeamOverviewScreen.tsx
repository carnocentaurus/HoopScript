...
const TeamOverviewScreen = ({ city, roster, history, teamStanding, onBack }: TeamOverviewScreenProps) => {
  ...
  const StatItem = ({ label, value }: { label: string, value: string }) => (
    <View style={globalStyles.tosStatCell}>
      <Text style={globalStyles.tosStatValue}>{value}</Text>
      <Text style={globalStyles.tosStatLabel}>{label}</Text>
    </View>
  );
    ...
    <Screen>
      <ScrollView style={globalStyles.tosContainer} showsVerticalScrollIndicator={false}>
        ...
        <View style={globalStyles.tosTeamSeasonAveragesRow}>
          {/* TOP ROW: COUNTING STATS */}
          <View style={globalStyles.tosTeamStatRowTop}>
            <StatItem label="PPG" value={teamAvgs.ppg} />
            <StatItem label="RPG" value={teamAvgs.rpg} />
            <StatItem label="APG" value={teamAvgs.apg} />
            <StatItem label="SPG" value={teamAvgs.spg} />
            <StatItem label="BPG" value={teamAvgs.bpg} />
          </View>
          
          {/* BOTTOM ROW: EFFICIENCY & POSSESSION */}
          <View style={globalStyles.tosTeamStatRowBottom}>
            <StatItem label="TOPG" value={teamAvgs.topg} />
            <StatItem label="FG%" value={teamAvgs.fgPct} />
            <StatItem label="3P%" value={teamAvgs.threePct} />
          </View>
        </View>
