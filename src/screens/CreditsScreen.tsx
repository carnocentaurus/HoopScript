    ...
    <Screen>
      ...
      <ScrollView contentContainerStyle={{ padding: 20 }}>
        <View style={[globalStyles.hiHistoryCard, { marginBottom: 30 }]}>
          ...
          <Text style={[globalStyles.hiUserStat, { marginTop: 5 }]}>by malle99</Text>
          <TouchableOpacity onPress={() => openUrl('https://freesound.org/s/496760/')}>
            <Text style={[globalStyles.textTerracotta, { marginTop: 10, textDecorationLine: 'underline' }]}>Source: Freesound.org</Text>
          </TouchableOpacity>
        ...
        <View style={globalStyles.hiHistoryCard}>
          ...
          <Text style={[globalStyles.hiUserStat, { marginTop: 5 }]}>by Andrii Poradovskyi</Text>
          <TouchableOpacity onPress={() => openUrl('https://pixabay.com/users/poradovskyi-52868186/')}>
            <Text style={[globalStyles.textTerracotta, { marginTop: 10, textDecorationLine: 'underline' }]}>Artist: Pixabay Profile</Text>
          </TouchableOpacity>
          <TouchableOpacity onPress={() => openUrl('https://pixabay.com/music/beats-basketball-nba-basketball-music-426800/')}>
            <Text style={[globalStyles.textTerracotta, { marginTop: 5, textDecorationLine: 'underline' }]}>Source: Pixabay Music</Text>
          </TouchableOpacity>
